...
synthr: raylib
ifneq (,$(synthr_config))
	@echo "==== Building synthr ($(synthr_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f synthr.make config=$(synthr_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f synthr.make clean
